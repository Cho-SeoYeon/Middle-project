...
public class ManagementLodgingVO extends PagingVo {
	...
	private String lod_mail;
	private String lod_cont;
	private String lod_info;
	private String l_img_path;
	private int room_no;
	private int room_price;
	private String room_type;
	private int room_prs;
	private int r_img_no;
	...
	public String getLod_mail() {
		return lod_mail;
	}
	public void setLod_mail(String lod_mail) {
		this.lod_mail = lod_mail;
	}
	public String getLod_cont() {
		return lod_cont;
	}
	public void setLod_cont(String lod_cont) {
		this.lod_cont = lod_cont;
	}
	...
	public int getRoom_prs() {
		return room_prs;
	}
	public void setRoom_prs(int room_prs) {
		this.room_prs = room_prs;
	}
	public int getR_img_no() {
		return r_img_no;
	}
	public void setR_img_no(int r_img_no) {
		this.r_img_no = r_img_no;
	}
